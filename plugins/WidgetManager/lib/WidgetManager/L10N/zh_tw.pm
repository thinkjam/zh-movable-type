...
package WidgetManager::L10N::zh_tw;
...
## plugins/WidgetManager/WidgetManager.pl
	'Widget Manager version 1.1; This version of the plugin is to upgrade data from older version of Widget Manager that has been shipped with Movable Type to the Movable Type core schema.  No other features are included.  You can safely remove this plugin after installing/upgrading Movable Type.' => 'Widget Manager 版本 1.1；此版本的插件用于将 Movable Type 附带的旧版本 Widget Manager 中的數據升級到 Movable Type 核心架構。  不包括其他功能。  安裝/升級 Movable Type 后，您可以安全地刪除此插件。',
