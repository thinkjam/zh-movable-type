...
package MT::Commercial::L10N::zh_tw;
...
## addons/Commercial.pack/config.yaml
	'A collection of styles compatible with Professional themes.' => '与 Professional 主题兼容的样式集合。',
	...
	'Comments' => '評論',
	'Contact' => '聯系人',
	'Converting CustomField type...' => '正在转换 CustomField 類型...',
	'Create a blog as a part of structured website. This works best with Professional Website theme.' => '創建博客作为結構化網站的一部分。这最适合专业網站主题。',
	...
	'Main Sidebar' => '主侧边栏',
	'Manage' => '管理',
	'Migrating CustomFields type...' => '正在迁移 CustomFields 類型...',
	...
	'Photo' => '照片',
	'Popup Image' => '弹出圖像',
	'Powered By (Footer)' => '技术支持（頁腳）',
	'Professional Blog' => '专业博客',
	'Professional Styles' => '专业风格',
	'Professional Website' => '专业網站',
	'Professionally designed, well-structured and easily adaptable web site. You can customize default pages, footer and top navigation easily.' => '专业設計、結構良好且易于調整的網站。您可以轻松自定义默認頁面、頁腳和顶部導航。',
	'RSD' => '相對標准差',
	'Recent Assets' => '最近資产',
	'Recent Comments' => '最近評論',
	'Recent Entries Expanded' => '最近条目展开',
	'Recent Entries' => '最近条目',
	'Required' => '必填',
	...
	'Unknown Object' => '未知對象',
	'Unknown Type' => '未知類型',
	'Updating Universal Template Set to Professional Website set...' => '正在将通用模板集更新为专业網站集...',
	'Welcome to our new website!' => '欢迎来到我们的新網站！',
	'[_1] [_3] [_2]' => '[_1][_3][_2]',
	'_PWT_ABOUT_BODY' => '
...
## addons/Commercial.pack/lib/CustomFields/App/CMS.pm
	...
	'Please enter all allowable options for this field as a comma delimited list' => '请以逗号分隔列表的形式輸入此字段的所有允许選项',
...
## addons/Commercial.pack/lib/CustomFields/Theme.pm
	...
	'Template Tag' => '模板標記',
	'[_1] custom fields' => '[_1] 自定义字段',
	'a field on system wide' => 'a field on system wide',
	'a field on this blog' => 'a field on this blog',

## addons/Commercial.pack/lib/CustomFields/Upgrade.pm
	'Moving metadata storage for pages...' => '移動頁面的元數據存儲...',
	'Removing CustomFields display-order from plugin data...' => '正在从插件數據中刪除 CustomFields 顯示顺序...',
	'Removing unlinked CustomFields...' => '刪除未鏈接自定义字段...',
...
## addons/Commercial.pack/templates/professional/blog/about_this_page.mtml
	...
	'This page is an archive of entries from <strong>[_1]</strong> listed from newest to oldest.' => '此頁面是从最新到最旧列出的 <strong>[_1]</strong> 条目的存檔。',
...
## addons/Commercial.pack/templates/professional/blog/entry_listing.mtml
	'Recently by <em>[_1]</em>' => '最近由 <em>[_1]</em>',
...
## addons/Commercial.pack/templates/professional/blog/recent_comments.mtml
	'<a href="[_1]">[_2] commented on [_3]</a>: [_4]' => '<a href="  ">[_2]對[_3]</a> 發表了評論：[_4]',
...
## addons/Commercial.pack/templates/professional/website/blogs.mtml
	'Entries ([_1]) Comments ([_2])' => '条目 ([_1]) 評論 ([_2])',
...
## addons/Commercial.pack/templates/professional/website/recent_entries_expanded.mtml
	'By [_1] | Comments ([_2])' => '作者 |[_1]| 匹配。評論 ([_2])',
	'on [_1]' => 'on [_1]',
...
## addons/Commercial.pack/templates/professional/website/search_results.mtml
	'By default, this search engine looks for all words in any order. To search for an exact phrase, enclose the phrase in quotes:' => '默認情况下，此搜索引擎会按任意顺序查找所有单词。要搜索確切的短語，请将短語括在引号中：',
...
## addons/Commercial.pack/tmpl/category_fields.tmpl
	'Show These Fields' => '顯示这些字段',

## addons/Commercial.pack/tmpl/edit_field.tmpl
	'Choose the system object where this custom field should appear.' => '選擇应在其中顯示此自定义字段的系統對象。',
	'Default' => '默認',
	'Delete this field (x)' => '刪除此字段 (x)',
	'Edit Custom Field' => '編輯自定义字段',
	'Example Template Code' => '示例模板代碼',
	'Must the user enter data into this custom field before the object may be saved?' => '用戶必須在保存對象之前在此自定义字段中輸入數據吗？',
	'Options' => '選项',
	'Required?' => '必需吗？',
	'Save this field (s)' => '保存此字段',
	'Save' => '保存',
	'Select...' => '選擇...',
	'Show In These [_1]' => '在这些[_1]中展示',
	'The basename must be unique within this [_1].' => '基本名称在此[_1]中必須是唯一的。',
	'The selected field(s) has been deleted from the database.' => '選定的字段已从垃圾郵件中刪除。數據庫。',
	'You must enter information into the required fields highlighted below before the custom field can be created.' => '您必須在創建自定义字段之前，在下面突出顯示的必填字段中輸入信息。',
	'You must save this custom field before setting a default value.' => '您必須在設置默認值之前保存此自定义字段。',
	'Your changes have been saved.' => '您的更改已保存。',
	'field' => 'field',
	'fields' => 'fields',
	q{Warning: Changing this field's basename may require changes to existing templates.} => q{警告：更改此字段的基本名称可能需要更改现有模板。},
