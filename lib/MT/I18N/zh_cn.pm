...
my $ENCODING_NAMES = [
    { 'name' => 'guess',     'display_name' => '自动检测' },
    { 'name' => 'utf8',      'display_name' => 'UTF-8' },
    { 'name' => 'gb2312',    'display_name' => 'GB2312' },
    { 'name' => 'gbk',       'display_name' => 'GBK' },
...
my @ENCODINGS_ENCODE = qw( utf-8 gb2312 gbk gb18030 cp936 );

{
    no warnings 'redefine';
    *MT::I18N::encode_text    = \&encode_text_zh_cn;
    *MT::I18N::guess_encoding = \&guess_encoding_zh_cn;
    *MT::I18N::wrap_text      = \&wrap_text_zh_cn;
    *MT::I18N::first_n        = \&first_n_zh_cn;
    *MT::I18N::first_n_text   = \&first_n_zh_cn;
}

sub encode_text_zh_cn {
    return __PACKAGE__->encode_text_encode(@_);
}

sub guess_encoding_zh_cn {
