...
package MT::Commercial::L10N::zh_cn;
...
## addons/Commercial.pack/config.yaml
	...
	'Comments' => '评论',
	'Contact' => '联系人',
	'Converting CustomField type...' => '正在转换 CustomField 类型...',
	'Create a blog as a part of structured website. This works best with Professional Website theme.' => '创建博客作为结构化网站的一部分。这最适合专业网站主题。',
	...
	'Main Sidebar' => '主侧边栏',
	'Manage' => '管理',
	'Migrating CustomFields type...' => '正在迁移 CustomFields 类型...',
	...
	'Photo' => '照片',
	'Popup Image' => '弹出图像',
	'Powered By (Footer)' => '技术支持（页脚）',
	'Professional Blog' => '专业博客',
	'Professional Styles' => '专业风格',
	'Professional Website' => '专业网站',
	'Professionally designed, well-structured and easily adaptable web site. You can customize default pages, footer and top navigation easily.' => '专业设计、结构良好且易于调整的网站。您可以轻松自定义默认页面、页脚和顶部导航。',
	'RSD' => '相对标准差',
	'Recent Assets' => '最近资产',
	...
	'Unknown Object' => '未知对象',
	'Unknown Type' => '未知类型',
	'Updating Universal Template Set to Professional Website set...' => '正在将通用模板集更新为专业网站集...',
	'Welcome to our new website!' => '欢迎来到我们的新网站！',
	'[_1] [_3] [_2]' => '[_1][_3][_2]',
	'_PWT_ABOUT_BODY' => '
...
## addons/Commercial.pack/lib/CustomFields/App/CMS.pm
	...
	'Please enter all allowable options for this field as a comma delimited list' => '请以逗号分隔列表的形式输入此字段的所有允许选项',
...
## addons/Commercial.pack/lib/CustomFields/Upgrade.pm
	'Moving metadata storage for pages...' => '移动页面的元数据存储...',
	'Removing CustomFields display-order from plugin data...' => '正在从插件数据中删除 CustomFields 显示顺序...',
	'Removing unlinked CustomFields...' => '删除未链接自定义字段...',
...
## addons/Commercial.pack/templates/professional/blog/about_this_page.mtml
	...
	'This page is an archive of entries from <strong>[_1]</strong> listed from newest to oldest.' => '此页面是从最新到最旧列出的 <strong>[_1]</strong> 条目的存档。',
...
## addons/Commercial.pack/templates/professional/website/blogs.mtml
	'Entries ([_1]) Comments ([_2])' => '条目 ([_1]) 评论 ([_2])',
...
## addons/Commercial.pack/templates/professional/website/recent_entries_expanded.mtml
	'By [_1] | Comments ([_2])' => '作者 |[_1]| 匹配。评论 ([_2])',
	'on [_1]' => 'on [_1]',
...
## addons/Commercial.pack/templates/professional/website/search_results.mtml
	'By default, this search engine looks for all words in any order. To search for an exact phrase, enclose the phrase in quotes:' => '默认情况下，此搜索引擎会按任意顺序查找所有单词。要搜索确切的短语，请将短语括在引号中：',
...
## addons/Commercial.pack/tmpl/category_fields.tmpl
	'Show These Fields' => '显示这些字段',

## addons/Commercial.pack/tmpl/edit_field.tmpl
	'Choose the system object where this custom field should appear.' => '选择应在其中显示此自定义字段的系统对象。',
	'Default' => '默认',
	'Delete this field (x)' => '删除此字段 (x)',
	'Edit Custom Field' => '编辑自定义字段',
	'Example Template Code' => '示例模板代码',
	'Must the user enter data into this custom field before the object may be saved?' => '用户必须在保存对象之前在此自定义字段中输入数据吗？',
	'Options' => '选项',
	'Required?' => '必需吗？',
	...
	'The basename must be unique within this [_1].' => '基本名称在此[_1]中必须是唯一的。',
	'The selected field(s) has been deleted from the database.' => '选定的字段已从垃圾邮件中删除。数据库。',
	'You must enter information into the required fields highlighted below before the custom field can be created.' => '您必须在创建自定义字段之前，在下面突出显示的必填字段中输入信息。',
	'You must save this custom field before setting a default value.' => '您必须在设置默认值之前保存此自定义字段。',
